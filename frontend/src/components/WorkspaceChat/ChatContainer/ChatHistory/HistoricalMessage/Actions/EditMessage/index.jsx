    ...
    >
      <button
        ...
        data-tooltip-content={t(
          role === "user"
            ? "editMessageAction.editPromptTooltip"
            : "editMessageAction.editResponseTooltip"
        )}
        className="border-none text-zinc-300"
        aria-label={t(
          role === "user"
            ? "editMessageAction.editPromptAria"
            : "editMessageAction.editResponseAria"
        )}
      >
        <Pencil
    ...
    <form onSubmit={handleSaveMessage} className="flex flex-col w-full">
      ...
      <div className="mt-3 flex justify-center">
        ...
        <button
          ...
          onClick={cancelEdits}
        >
          {t("editMessageForm.cancelButton")}
        </button>
      </div>
    </form>
  );
