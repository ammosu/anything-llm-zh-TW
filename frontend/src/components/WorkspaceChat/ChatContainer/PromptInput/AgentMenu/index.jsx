...
export default function AvailableAgentsButton({ showing, setShowAgents }) {
  ...
  return (
    <div
      ...
      data-tooltip-content={t("availableAgents.tooltipContent")}
      aria-label={t("availableAgents.tooltipContent")}
            ...
            >
              <div className="w-full flex-col text-left flex pointer-events-none">
                <div className="text-theme-text-primary text-sm">
                  <b>@agent</b> - {t("availableAgents.defaultAgentDescription")}
                </div>
                <div className="flex flex-wrap gap-2 mt-2">
                  <AbilityTag text={t("abilities.ragSearch")} />
                  <AbilityTag text={t("abilities.webScraping")} />
                  <AbilityTag text={t("abilities.webBrowsing")} />
                  <AbilityTag text={t("abilities.saveFile")} />
                  <AbilityTag text={t("abilities.listDocuments")} />
                  <AbilityTag text={t("abilities.summarizeDocument")} />
                  <AbilityTag text={t("abilities.chartGeneration")} />
                </div>
              </div>
            </button>
            <button
