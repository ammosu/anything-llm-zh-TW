  ...
  const handleCreate = async (e) => {
    ...
    if (folderName.trim() !== "") {
      ...
      if (success) {
        ...
        setError(t("newFolderModal.error"));
      }
    }
  };
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={t("newFolderModal.placeholder")}
                  required={true}
                  autoComplete="off"
                  value={folderName}
              ...
              {error && <p className="text-red-400 text-sm">{t("newFolderModal.error")}</p>}
            </div>
